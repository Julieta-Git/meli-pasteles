...
const DESIGN_GALLERY = {
  redondas: {
    ...
    images: [
      ...
      { src: "img/tortas-redondas/torta-redonda2(23).jpg", alt: "Torta redonda 6" },
      { src: "img/tortas-redondas/torta-redonda2(24).jpg", alt: "Torta redonda 7" },
      { src: "img/tortas-redondas/torta-redonda2(25).jpg", alt: "Torta redonda 8" },
      { src: "img/tortas-redondas/torta-redonda2(26).jpg", alt: "Torta redonda 9" },
      { src: "img/tortas-redondas/torta-redonda2(27).jpg", alt: "Torta redonda 10" },
      { src: "img/tortas-redondas/torta-redonda2(28).jpg", alt: "Torta redonda 11" },
      { src: "img/tortas-redondas/torta-redonda2(29).jpg", alt: "Torta redonda 12" },
      { src: "img/tortas-redondas/torta-redonda2(30).jpg", alt: "Torta redonda 13" },
      { src: "img/tortas-redondas/torta-redonda2(31).jpg", alt: "Torta redonda 14" },
      { src: "img/tortas-redondas/torta-redonda2(32).jpg", alt: "Torta redonda 15" },
      { src: "img/tortas-redondas/torta-redonda2(33).jpg", alt: "Torta redonda 16" },
      { src: "img/tortas-redondas/torta-redonda2(34).jpg", alt: "Torta redonda 17" },
      { src: "img/tortas-redondas/torta-redonda2(35).jpg", alt: "Torta redonda 18" },
      { src: "img/tortas-redondas/torta-redonda2(36).jpg", alt: "Torta redonda 19" },
      { src: "img/tortas-redondas/torta-redonda2(37).jpg", alt: "Torta redonda 20" },
      { src: "img/tortas-redondas/torta-redonda2(38).jpg", alt: "Torta redonda 21" },
      { src: "img/tortas-redondas/torta-redonda2(39).jpg", alt: "Torta redonda 22" },
      { src: "img/tortas-redondas/torta-redonda2(40).jpg", alt: "Torta redonda 23" },
      { src: "img/tortas-redondas/torta-redonda2(41).jpg", alt: "Torta redonda 24" }
    ]
  },
  redonda_frutal: {
